---
title: lineage-upstream
sidebar_label: lineage-upstream
---

# Cypher preset · `lineage-upstream`

Source: [`apps/gateway/src/lineage_gateway/presets/lineage-upstream.cypher`](https://github.com/utkarshsingh1102/Ariadne---Lineage-Platform/blob/main/lineage-platform/apps/gateway/src/lineage_gateway/presets/lineage-upstream.cypher).
